...
class ServerSendsLeafCertificateClientTrustsRootCaTest extends AbstractWebAppTest {

  @Test
  @DisplayName("Server sends leaf certificate only, client trusts Root CA -> Handshake Failure")
  void test() {
